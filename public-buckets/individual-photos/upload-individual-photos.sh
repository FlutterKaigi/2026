...
# =============================================================================
# FlutterKaigi 2026 個人スポンサー写真 アップロードスクリプト
# =============================================================================
# photos/ 配下の画像を R2 公開バケット (2026-public-production) にアップロードする。
# 企業スポンサーロゴ (public-buckets/sponsor-logos/) とはプレフィックスを分け、
# `individual/` 配下に独立して置く。
#
# 前提:
#   - rclone がインストール済み
...
#
# アップロード後の公開URL:
#   https://2026-bucket.flutterkaigi.jp/individual/<ファイル名>
# =============================================================================

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SOURCE_DIR="$SCRIPT_DIR/photos"
RCLONE_REMOTE="r2"
BUCKET_NAME="2026-public-production"
DEST_PREFIX="individual"
...
if [ ! -d "$SOURCE_DIR" ]; then
  echo "ERROR: 写真ディレクトリがありません: $SOURCE_DIR" >&2
  exit 1
fi
