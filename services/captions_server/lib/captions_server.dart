...
/// Selects a per-connection [SinkFactory] from [config].
SinkFactory buildSinkFactory(Config config) {
  switch (config.sink) {
    case 'console':
    ...
    case 'firestore':
      ...
      return (startMs) => FirestoreSink(firestore, connectionStartMs: startMs);
    default:
...
Handler createCaptionsHandler(
  ...
  final router = buildRouter(
    ...
    sinkFactory: sinkFactory ?? buildSinkFactory(config),
  );
