...
mixin _$Contributor {
 ...
 String get login; String get avatarUrl; String get htmlUrl; int get contributions;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String login,  String avatarUrl,  String htmlUrl,  int contributions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Contributor() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String login,  String avatarUrl,  String htmlUrl,  int contributions)  $default,) {final _that = this;
switch (_that) {
case _Contributor():
return $default(_that.login,_that.avatarUrl,_that.htmlUrl,_that.contributions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String login,  String avatarUrl,  String htmlUrl,  int contributions)?  $default,) {final _that = this;
switch (_that) {
case _Contributor() when $default != null:
return $default(_that.login,_that.avatarUrl,_that.htmlUrl,_that.contributions);case _:
  return null;
...
class _Contributor implements Contributor {
  const _Contributor({required this.login, required this.avatarUrl, required this.htmlUrl, required this.contributions});
