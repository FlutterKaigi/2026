...
/// uid of the other attendee, which is also the document id.
 String get id;@FirestoreDateTimeConverter() DateTime get createdAt; ProfileExchangeOrigin get origin;/// Signed exchange token presented when this document was created by a
