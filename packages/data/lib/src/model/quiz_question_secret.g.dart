...
_QuizQuestionSecret _$QuizQuestionSecretFromJson(Map<String, dynamic> json) => _QuizQuestionSecret(
...
Map<String, dynamic> _$QuizQuestionSecretToJson(_QuizQuestionSecret instance) => <String, dynamic>{
