...
_QuizQuestion _$QuizQuestionFromJson(Map<String, dynamic> json) => _QuizQuestion(
  id: json['id'] as String,
  sponsorId: json['sponsorId'] as String,
  order: (json['order'] as num).toInt(),
  title: LocaleMap.fromJson(json['title'] as Map<String, dynamic>),
  options:
      (json['options'] as List<dynamic>?)?.map((e) => LocaleMap.fromJson(e as Map<String, dynamic>)).toList() ??
      const [],
  ...
  explanation: json['explanation'] == null ? null : LocaleMap.fromJson(json['explanation'] as Map<String, dynamic>),
);

Map<String, dynamic> _$QuizQuestionToJson(_QuizQuestion instance) => <String, dynamic>{
  'id': instance.id,
